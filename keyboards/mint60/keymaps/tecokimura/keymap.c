...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LY_NORMAL] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_Q,      KC_UP,  MO(1),   \
    KC_ESC,  KC_LGUI, KC_LALT,  KC_BSPC,          KC_SPC,      LT_CRSR,  KC_ENT,  LALT(KC_GRV),               KC_LEFT,KC_DOWN,KC_RGHT \
  ),

  [LY_CURSOR] = LAYOUT( \
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_HOME,  KC_MINS,  KC_EQL,    KC_DEL, \
    RGB_TOG,   _______,  _______, KC_END, RGB_VAI, XXXXXXX,   KC_HOME, KC_PGDN, KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    XXXXXXX,     KC_HOME, KC_SPC, KC_DEL, XXXXXXX, XXXXXXX,     KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_END, XXXXXXX,        KC_ENT, \
    _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC,   KC_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_PGUP, _______, \
  ...
  [LY_NUMBER] = LAYOUT( \
    ...
    XXXXXXX,     XXXXXXX, KC_SPC, KC_DEL, XXXXXXX, XXXXXXX,   XXXXXXX,   KC_4,    KC_5,    KC_6,    KC_PLUS, KC_ASTR,        XXXXXXX, \
