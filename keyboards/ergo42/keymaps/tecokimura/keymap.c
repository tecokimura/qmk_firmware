...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [LY_NORMAL] = LAYOUT( \
    LT_MOUS,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,          KC_RBRC,    KC_Y,    KC_U,   KC_I,     KC_O,     KC_P,     KC_MINS, \
    ...
    LT_NUMB,  KC_LGUI, KC_LALT, KC_APP,  KC_BSPC, LT_CRSR, _______,          _______,    LT_CRSR, KC_ENT, _______,  _______,  _______,  LT_FUNC \
  ),
...
*/
    _______, _______, _______, KC_ENT,  _______, KC_TAB,  _______,    _______, _______, KC_PGDN, KC_PGUP,  KC_HOME,    KC_PSCR,   KC_BSPC, \
    KC_LCTL, KC_HOME, KC_SPC,  KC_DEL,  _______, _______, _______,    KC_HOME, KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT,    KC_END,    KC_QUOT, \
    KC_LSFT, _______, _______, _______, _______, KC_BSPC, _______,    _______, KC_ENT,  _______, _______,  _______,    KC_SLSH,   KC_RO,   \
    _______, S(KC_1), S(KC_2), S(KC_3), S(KC_4), _______, _______,    _______, _______, S(KC_9), S(KC_0),  S(KC_MINS), S(KC_EQL), _______ \
),
  ...
  [LY_FUNC] = LAYOUT( \
    ...
    KC_LCTRL, _______, _______, _______, _______, _______, _______,    S(KC_BSLS), _______, _______, _______,    _______,    _______,    _______, \
    KC_LSFT,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,      KC_GRV,     _______, _______, _______,    _______,    _______,    SFT_T(KC_RO), \
    RESET,    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,     _______,    KC_ENT,  _______, _______,    _______,    KC_DOT,     _______  \
  )
