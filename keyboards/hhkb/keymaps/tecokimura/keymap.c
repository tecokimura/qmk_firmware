...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   LT_LFN, KC_LALT, KC_LGUI, KC_BSPC, KC_BSPC,      LT_CRSR,        KC_ENT,  KC_ENT,  KC_RALT,  LT_RFN,  KC_LEFT, KC_DOWN,   KC_RGHT),
  ...
  _______, KC_ZKHK, _______, KC_LALT, _______,       _______,       _______, KC_KANA, _______,  _______,    KC_LEFT, KC_DOWN, KC_RGHT),
